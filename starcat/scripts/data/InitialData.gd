...
static func _technology_nodes() -> Array:
	return [
		...
		{"id": "tech_shipyard", "name": "太空船坞", "tier": 1, "category": "MILITARY", "description": "解锁基础船坞建设与舰船标准化生产。", "effects": ["解锁太空船坞建筑", "新造护卫舰 +15 生命 / +4 伤害", "所有新造舰船 +1 速度", "新造舰船成本 -9 矿产 / -7 工业"], "unlocks": ["驱逐舰船体", "舰队后勤"], "status": "AVAILABLE", "cost": 80, "researchTime": 2, "progress": 0.0},
		...
		{"id": "tech_diplomatic_protocols", "name": "星际礼制协议", "tier": 2, "category": "ECONOMY", "description": "确立正式条约缔结流程与外交规范。", "effects": ["解锁互不侵犯 / 科研协定 / 同盟", "正式条约接受判定 +25 信任权重"], "unlocks": ["自动装配线", "联邦议会"], "status": "LOCKED", "cost": 120, "researchTime": 3, "progress": 0.0, "prerequisites": ["tech_trade_net"]},
		...
		{"id": "tech_fleet_logistics", "name": "舰队后勤", "tier": 2, "category": "MILITARY", "description": "改善舰队补给效率与维修流程。", "effects": ["解锁战术指挥核心前置体系", "舰队整编效率 +1 级"], "unlocks": ["战术指挥核心"], "status": "LOCKED", "cost": 120, "researchTime": 3, "progress": 0.0, "prerequisites": ["tech_shipyard"]},
		{"id": "tech_applied_robotics", "name": "应用机器人", "tier": 2, "category": "SCIENCE", "description": "让自动化单元进入工业与科研岗位。", "effects": ["工业流程自动化等级 +1", "科研辅助单元部署位 +2"], "unlocks": ["量子建模"], "status": "LOCKED", "cost": 120, "researchTime": 3, "progress": 0.0, "prerequisites": ["tech_research_lab"]},
		{"id": "tech_colony_charter", "name": "殖民章程", "tier": 2, "category": "EXPANSION", "description": "为远星殖民制定统一治理范本。", "effects": ["殖民成长系数 +0.25", "殖民地每回合额外 +2 稳定度"], "unlocks": ["地貌改造"], "status": "LOCKED", "cost": 100, "researchTime": 3, "progress": 0.0, "prerequisites": ["tech_deep_colonization"]},
		{"id": "tech_deep_space_scans", "name": "深空侦测", "tier": 2, "category": "EXPANSION", "description": "提升远距离星图扫描与异常信号识别能力。", "effects": ["通信截获能力 +40%", "异常信号识别等级 +1"], "unlocks": ["边境灯塔"], "status": "LOCKED", "cost": 110, "researchTime": 2, "progress": 0.0, "prerequisites": ["tech_expanded_housing"]},
		{"id": "tech_auto_assembly", "name": "自动装配线", "tier": 3, "category": "ECONOMY", "description": "建立矿产到工业的自动装配流程。", "effects": ["建筑队列推进 +1", "工业装配效率 +1 级"], "unlocks": ["行星协调网"], "status": "LOCKED", "cost": 180, "researchTime": 4, "progress": 0.0, "prerequisites": ["tech_diplomatic_protocols"]},
		...
		{"id": "tech_tactical_core", "name": "战术指挥核心", "tier": 3, "category": "MILITARY", "description": "通过战术 AI 提升舰队联合作战能力。", "effects": ["舰队战术协同等级 +1", "主力舰编队效率 +1 级"], "unlocks": ["旗舰系统"], "status": "LOCKED", "cost": 210, "researchTime": 4, "progress": 0.0, "prerequisites": ["tech_destroyer_hulls", "tech_fleet_logistics"]},
		...
		{"id": "tech_terraforming", "name": "地貌改造", "tier": 3, "category": "EXPANSION", "description": "改善殖民星环境并扩大长期产能。", "effects": ["宜居度改造等级 +1", "殖民地资源开发位 +1"], "unlocks": ["边境星域长期控制"], "status": "LOCKED", "cost": 180, "researchTime": 4, "progress": 0.0, "prerequisites": ["tech_colony_charter"]},
		{"id": "tech_planetary_grid", "name": "行星协调网", "tier": 4, "category": "ECONOMY", "description": "把产业、能源、物流与治理统一进协调网络。", "effects": ["通信截获能力 +20%", "全域统筹效率 +1 级"], "unlocks": ["联邦议会"], "status": "LOCKED", "cost": 260, "researchTime": 5, "progress": 0.0, "prerequisites": ["tech_auto_assembly", "tech_deep_space_scans"]},
		...
		{"id": "tech_quantum_modeling", "name": "量子建模", "tier": 4, "category": "SCIENCE", "description": "用量子模拟缩短复杂工程与科研周期。", "effects": ["量子推演效率 +1 级", "复杂课题拆解位 +2"], "unlocks": ["奇点格构"], "status": "LOCKED", "cost": 260, "researchTime": 5, "progress": 0.0, "prerequisites": ["tech_applied_robotics", "tech_star_harmonics"]},
